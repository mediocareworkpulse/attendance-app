...
# ---------- SALES, PROFILE, REPORTS, LEAVES (unchanged from previous full version) ----------
# Include the remaining routes exactly as in the last full app.py
# (sales, profile, reports, leaves, leave-pdf, approve-leaves, process-leave, error handler)
# For brevity they are not repeated, but your final app.py MUST contain them.
